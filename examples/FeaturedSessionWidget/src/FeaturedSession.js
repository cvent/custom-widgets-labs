// an accessory custom element that creates a card element to display information about a particular session
export class FeaturedSession extends HTMLDivElement {
  constructor(session, theme, config, imageURL) {
    ...
    // get information from the SessionDetail object from this session
    ...
    // append all child elements to the div
